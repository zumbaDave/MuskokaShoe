    ...
    return (
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs font-muted-foreground">Based on 100 Charges</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs font-muted-foreground">Total Sales on Muskoka Shoe</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs font-muted-foreground">Total Products Created</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs font-muted-foreground">Total Users Signed Up</p>
          </CardContent>
        </Card>
      </div>        
    );
